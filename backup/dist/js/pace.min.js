    ...
    u = function(t) {
        ...
        return t.prototype.getElement = function() {
            ...
            if (null == this.el) {
                ...
                this.el.innerHTML = '<div class="pace-activity"><div class="pace-progress">\n  <div class="pace-progress-inner"></div>\n<div class="loading"></div></div></div>', 
            ...
            for (t = this.getElement(), r = "translate3d(" + this.progress + "%, 0, 0)", i = ["webkitTransform", "msTransform", "transform"], s = 0, o = i.length; o > s; s++) e = i[s], t.querySelector('.pace-progress-inner').style[e] = r;

            return (!this.lastRenderedProgress || this.lastRenderedProgress | 0 !== this.progress | 0) && (t.querySelector('.pace-progress-inner').setAttribute("data-progress-text", "" + (0 | this.progress) + "%"), this.progress >= 100 ? n = "99" : (n = this.progress < 10 ? "0" : "", n += 0 | this.progress), t.querySelector('.pace-progress-inner').setAttribute("data-progress", "" + n)), this.lastRenderedProgress = this.progress
